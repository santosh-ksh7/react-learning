...
import { MovieLogic } from './MovieLogic';
...
function App() {
  ...
  return (
    <div className="mainfuncmaincont">
        ...
        <Paper sx={{borderRadius: "0px", minHeight: "100vh"}}>
          <AppBar position="static">
            <Toolbar>
              ...
              {/* <Button onClick={()=>navigate("/tictactoe")} color="inherit">Tic-Tac-Toe</Button> */}
          ...
          <Routes>
            ...
            <Route path='/movies' element={<MovieLogic />}></Route>
            <Route path='/color-game' element={<Colorgame />}></Route>
            <Route path='/add-movie' element={<Addmovie />}></Route>
            <Route path="/movies/:id" element={<Additionalinfo />}></Route>
            <Route path="/movies/edit/:id" element={<Editinfo />}></Route>
